...
class MainApp extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
  static get properties(){
    return {
      name: { type: String },
    };
  ...
  static get styles() {
    return [_styles_main_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
  }
  ...
  render() {
    ...
    <h1>Testing</h1>
      <p class="test">Hello, ${this.name}!</p>
      `;
  }
}
